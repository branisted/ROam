...
router.put('/:id', requireAuth, (req, res, next) => postsController.updatePost(req, res, next));
router.delete('/:id', requireAuth, (req, res, next) => postsController.deletePost(req, res, next));
